...
2. If uncommitted changes exist, auto-commit to the feature branch with a descriptive message
...
5. If any document-type files (.md, .docx, .pdf) were created
...
that could be shared to other engineers. Look for:
...
**If shareable material exists:**

Draft the document(s) as native markdown and save to a drafts folder.
Present suggestions with the draft:

All wrap-up steps complete. I also found potential content to shareable:

1. "Title of Post" — 1-2 sentence description of the content angle.
   Draft saved to: Drafts/Title-Of-Post.md

Wait for the user to respond. If they approve, move into publish folder.
If they decline, the drafts remain for later.

**If no shareable material exists:**

Say "Nothing worth sharing from this session" and you're done.
